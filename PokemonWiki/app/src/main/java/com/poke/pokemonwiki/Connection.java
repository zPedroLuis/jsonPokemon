...
public class Connection{
    ...
    public List<Pokemon> sendGet() throws Exception {
        ...
        String url = "https://api.myjson.com/bins/1cq1lq";
    ...
    public List<Pokemon> findAllItems(JSONArray response) {
        ...
        try {
            ...
            for (int i = 0; i < response.length(); i++) {
                ...
                found.add(new Pokemon(obj.getString("pokedex"), obj.getString("pokemonName"),
                        obj.getString("type1"), obj.getString("type2"), obj.getString("region")));
            }
